    ...
    <main className="min-h-screen bg-background text-foreground">
      <div className="max-w-5xl mx-auto px-4 py-16 md:py-24 space-y-10">
        <section className="text-center space-y-4">
          <p className="text-xs uppercase tracking-wider text-muted-foreground">ArchAI</p>
          <h1 className="text-4xl md:text-6xl font-bold tracking-tight">Architecture Copilot</h1>
          <p className="text-muted-foreground max-w-2xl mx-auto">
            Generate deterministic architecture blueprints from a structured 12-level intake.
          </p>
